...
export const edition001: AnonymousEdition = {
  edition: 1,
  date: "September 2026",
  hookQuote: "80% of the vendors I've recommended, I have not worked with directly.",
  buyerPersona: "Global Head of Talent Acquisition",
  employer: "Global Multinational Company",
  companySize: "10,000+",
  technologies: ["ATS", "Assessment", "Sourcing"],
  topics: [
    "Cold outreach",
    "Peer influence",
  ...
  stage: ["Evaluation", "Selection", "Churn"],
  framing:
    "Every vendor tracks closed-lost. Almost none of them track what happens next. This buyer sits in closed peer networks where vendors are discussed openly, recommends products regularly, and hasn't taken a cold meeting in two years. What struck me most wasn't what he said about the vendors he chose. It was what he said about the ones he didn't, and what he's been doing for them ever since, without them knowing.",
  sections: [
    {
    ...
    {
      heading: "Quite a lot has already happened that they don't see.",
      exchanges: [
        {
          question:
            "When you are actively in the market with a problem to solve, what's the first thing you do?",
          answer:
    ...
    },
    {
      ...
      exchanges: [
        {
          question: "When you're in those vendor meetings, what separates the good from the bad?",
          answer:
    ...
    },
    {
      ...
      exchanges: [
        {
          question:
            "Have you ever gone with a vendor whose product wasn't as strong as a competitor's?",
          answer:
    ...
    },
    {
      ...
      exchanges: [
        ...
        {
          question: "That must be brutal for vendors.",
          answer:
    ...
    {
      heading: "They have no idea.",
      exchanges: [
        {
          question:
            "You mentioned a vendor you've known for years but never purchased from. Tell me about that.",
          answer:
        ...
        {
          question:
            "Have you ever recommended a vendor to a peer that you yourself didn't buy from?",
          answer:
        ...
        {
          question:
            'The vendor who "lost" that deal has no idea you\'re out there selling for them.',
          answer: "No. They have no idea.",
        },
      ],
    },
    {
      heading: "If they've messed up once, I would not use them again.",
      exchanges: [
        {
          question:
            "Have you ever ruled a vendor out because of something a peer told you before you'd ever spoken to that vendor yourself?",
          answer:
    ...
    {
      heading: "Tell me what you can afford, and how we can support you.",
      exchanges: [
        {
  ...
  stats: [
    {
      value: "80%",
      context: "of the vendors he's recommended to peers, he never bought from himself",
    },
    {
      value: "2 yrs",
      context: "since a cold approach last earned a meeting",
    },
    {
      value: "5",
      context: "vendor calls a day, now going unanswered",
    },
    {
      value: "4 yrs",
      context: "of relationship with a vendor before a buying opportunity appeared",
    },
  ],
};
