...
export const edition004: AnonymousEdition = {
  ...
  date: "September 2026",
  hookQuote:
    "She truly understands the problem I'm trying to solve. She doesn't try to upsell me. She helps me realise the value of the product.",
  ...
  framing:
    "This buyer rates his customer success manager as one of the best he's ever worked with. He rates her so highly he brought her with him when he changed companies. He is also, probably, going to leave her employer. Not because of anything she's done, but because the product stopped moving and a competitor didn't. The relationship was never with the vendor. It was with her.",
  sections: [
    {
      heading: "She's done nothing wrong.",
      exchanges: [
        {
          question: "How would you describe your customer success manager?",
          answer:
            "She's one of the best CSMs I've ever worked with. I brought her from my previous company to this one. She truly understands the problem I'm trying to solve. She doesn't try to upsell me. She helps me realise the value of the product.",
        },
        {
          question: "And you're still looking at leaving?",
          answer:
            "She's done nothing wrong. The product has stalled on reporting and been slow on MCP. A competitor can do things it can't.\n\nI also worked with a larger vendor where I felt like a nobody because I wasn't spending millions. Every QBR was an upsell.",
        },
      ],
    },
    {
  ...
  pullQuotes: [
    ...
    {
      quote: "Does it have an MCP? That's the most important factor now.",
