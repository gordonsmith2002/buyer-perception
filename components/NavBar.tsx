        ...
        <div className="flex min-h-20 items-center justify-between gap-6 py-4 sm:py-5">
          ...
          <div className="hidden md:flex items-center gap-8 lg:gap-10">
            ...
            <a
              ...
              className="inline-flex items-center justify-center rounded-md px-5 py-2.5 bg-terracotta text-white text-[15px] font-normal tracking-tight hover:bg-[#9a5a43] transition-colors"
            >
              Book a Conversation
            </a>
          </div>
          ...
          <div className="flex md:hidden items-center gap-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex rounded-md bg-terracotta text-white text-sm font-normal px-3.5 py-2"
            >
              Book a Conversation
            </a>
            <button
        ...
        {open ? (
          <div className="md:hidden border-t border-charcoal/10 py-4 flex flex-col gap-1 pb-6">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-3 text-center rounded-md bg-terracotta text-white text-[15px] font-normal py-3"
              onClick={() => setOpen(false)}
            >
              Book a Conversation
            </a>
