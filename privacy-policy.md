...
Buyer Perception runs confidential interviews with people who have bought, rejected or left B2B software, and turns what they say into insight for the companies that sell it. Confidentiality is the product. This policy explains what personal data we hold, why, and what we do to protect it.
...
### Charitable donations / thank-you payments

Where we offer one, it is a thank-you for your time and is not conditional on what you say. Many participants choose a donation to a charity of their choice; you can also take it as a gift card or retailer credit. It is delivered through Tremendous.
...
Your name, job title, employer, work email, work phone number, LinkedIn profile, and notes of our conversations. For clients and partners, contract and billing records as well.

### Where it comes from

From you directly, from introductions, from events, and from professional sources such as LinkedIn Sales Navigator and business contact enrichment services (currently FullEnrich), which supply publicly available or professionally published work contact details.
...
Our website host collects standard technical data (such as IP address and browser type) to keep the site secure and working. [If analytics are enabled: We use analytics cookies only with your consent, which you can change at any time via the cookie banner.]
...
We share it only with the service providers that help us run the business, under contracts that require them to protect it. Our current list is:

| Provider | Purpose |
|---|---|
| Google Workspace | Email and documents |
| HubSpot | Customer relationship management |
| Granola | Live interview transcription (no audio kept) |
| Anthropic | AI-assisted analysis of pseudonymised transcripts |
...
Some of our providers are based in, or process data in, the United States. Where personal data leaves the UK we rely on the UK Extension to the EU–US Data Privacy Framework, the UK International Data Transfer Agreement, or the UK Addendum to the EU Standard Contractual Clauses, as appropriate for each provider.
...
We will update this policy when our practices change and show the new version number and date at the top. Earlier versions are available on request.

Buyer Perception Ltd · 5th Floor, 167–169 Great Portland Street, London W1W 5PF · Company number 17336914 · privacy@buyerperception.com
